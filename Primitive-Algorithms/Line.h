...
inline void bresenhamX(int x0, int y0, int x1, int y1, int dx, int dy)
{
    int i, j, k;
    i = 2 * dy - dx;
    j = 2 * dy;
...
inline void bresenhamY(int x0, int y0, int x1, int y1, int dx, int dy)
{
    int i, j, k;
...
inline void bresenham(int x0, int y0, int x1, int y1)
{
    int dx = abs(x1 - x0);
    int dy = abs(y1 - y0);
